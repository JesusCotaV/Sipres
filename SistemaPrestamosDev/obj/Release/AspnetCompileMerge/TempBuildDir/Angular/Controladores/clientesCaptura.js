(function () {
    ...
    clientesCapCtrl.$inject = ['$scope', '$rootScope', "commonFactory"];
    //Inicio Funcion controlador
    function clientesCapCtrl($scope, $rootScope, common) {
        var ctrl = this;
        ////Variables////
        ctrl.Cliente = {};
        //////funciones//////
        ...
        function capturarCliente(nombre, apellido, celular, credito, ref1, ref2, ref1cel, ref2cel) {
            ...
            if (nombre == null || apellido == null || celular == null || credito == null) {
                Swal.fire({
